...
public class Vista {
    ...
    private void menuOperaciones() {
        operacion.setNumero1(leerDecimal("Ingrese el primer numero: "));
        operacion.setNumero2(leerDecimal("Ingrese el segundo numero: "));
    ...
    // ======== Submenú de áreas (versión sencilla) ========
    private void menuAreas() {
        ...
        switch (opcion) {
            case 1:
                double lado = leerDecimal("Ingrese el lado: ");
                System.out.println("Area del cuadrado: " + areas.areaCuadrado(lado));
                break;
            case 2:
                double baseR = leerDecimal("Ingrese la base: ");
                double alturaR = leerDecimal("Ingrese la altura: ");
                System.out.println("Area del rectangulo: " + areas.areaRectangulo(baseR, alturaR));
                break;
            case 3:
                double radio = leerDecimal("Ingrese el radio: ");
                System.out.println("Area de la circunferencia: " + areas.areaCircunferencia(radio));
                break;
            case 4:
                double baseT = leerDecimal("Ingrese la base: ");
                double alturaT = leerDecimal("Ingrese la altura: ");
